<x-app-layout>
    ...
    <div class="service-area py-8 md:py-16 lg:py-20 wow fadeInUp animated" data-wow-duration="1s" data-wow-delay="0.3s">
        <div class="container">
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-4 md:gap-6 p-4">
                <div class="w-full">
                    <div class="dark:border-2 dark:border-indigo-500 h-full rounded-xl py-6 px-5 md:py-8 md:px-7 text-center shadow-md transition-all hover:shadow-lg">
                        ...
                        <div>
                            ...
                            <a class="btn btn-border-base text-sm md:text-base w-full sm:w-auto" href="{{ route('admin.users.index') }}">Gérer les utilisateurs <i class="fa fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="w-full">
                    <div class="dark:border-2 dark:border-indigo-500 h-full rounded-xl py-6 px-5 md:py-8 md:px-7 text-center shadow-md transition-all hover:shadow-lg">
                        <div class="mx-auto mb-5 md:mb-7 inline-block"><svg width="60" height="60" viewBox="0 0 60 60" fill="none"
                        ...
                        <div>
                            <h3 class="mb-3 md:mb-4 text-lg md:text-xl font-bold text-black sm:text-xl lg:text-xl xl:text-2xl dark:text-white">Gestion des messages
                            </h3>
                            <p class="text-sm md:text-base font-medium text-body-color mb-4 dark:text-white">Vous pouvez consulter les messages reçus par vos utilisateurs.</p>

                            <a class="btn btn-border-base text-sm md:text-base w-full sm:w-auto" href="{{ route('contact.messages') }}">Voir les messages <i class="fa fa-arrow-right"></i></a>
                ...
                <div class="w-full">
                    <div class="dark:border-2 dark:border-indigo-500 h-full rounded-xl py-6 px-5 md:py-8 md:px-7 text-center shadow-md transition-all hover:shadow-lg">
                        <div class="mx-auto mb-5 md:mb-7 inline-block"><svg width="52" height="60" viewBox="0 0 52 60"
                        ...
                        <div>
                            <h3 class="mb-3 md:mb-4 text-lg md:text-xl font-bold text-black sm:text-xl lg:text-xl xl:text-2xl dark:text-white">Gestion des articles
                            </h3>
                            <p class="text-sm md:text-base font-medium text-body-color mb-4 dark:text-white">Consultez, ajoutez, modifiez ou supprimez les articles du système.</p>
                            <a class="btn btn-border-base text-sm md:text-base w-full sm:w-auto" href="{{ route('admin.blog.index') }}">Accéder <i class="fa fa-arrow-right"></i></a>
                        </div>
                ...
                <div class="w-full">
                    ...
                    <div class="mx-auto mb-7 inline-block"><svg width="58" height="60" viewBox="0 0 58 60"
                        ...
                        <div>
                            <h3 class="mb-3 md:mb-4 text-lg md:text-xl font-bold text-black sm:text-xl lg:text-xl xl:text-2xl dark:text-white">Gestion des catégories
                            </h3>
                            <p class="text-sm md:text-base font-medium text-body-color mb-4 dark:text-white">Consultez, ajoutez, modifiez ou supprimez les catégories du système.</p>
                            <a class="btn btn-border-base text-sm md:text-base w-full sm:w-auto" href="{{ route('admin.blog.categories.index') }}">Accéder <i class="fa fa-arrow-right"></i></a>
                        </div>
                ...
                <div class="w-full">
                    <div class="dark:border-2 dark:border-indigo-500 h-full rounded-xl py-6 px-5 md:py-8 md:px-7 text-center shadow-md transition-all hover:shadow-lg">
                        ...
                        <div>
                            ...
                            <a class="btn btn-border-base text-sm md:text-base w-full sm:w-auto" href="{{ route('admin.registrations.index') }}">Voir les inscriptions <i class="fa fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
