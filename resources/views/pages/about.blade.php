...
@section('content')
    ...
    <section class="py-16 bg-indigo-600 text-white">
        <div class="container mx-auto px-4 text-center">
            <h2 class="text-3xl font-bold mb-4">Rejoignez notre aventure</h2>
            <p class="text-xl mb-8 max-w-3xl mx-auto">Vous avez un projet digital ou souhaitez en savoir plus sur nos services ? N'hésitez pas à nous contacter.</p>
            <a href="{{ route('contact.index') }}" class="bg-white text-indigo-600 hover:bg-gray-100 px-8 py-4 rounded-lg font-semibold text-lg transition inline-block">Contactez-nous</a>
        </div>
    </section>
@endsection
