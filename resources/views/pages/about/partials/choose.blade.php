<section class="py-16 bg-gray-50">
    <div class="container mx-auto px-4">
        <div class="section-title mb-12 flex flex-col items-center justify-center">
            <p class="sub-title">Nos valeurs</p>
            <h2 class="title">Pourquoi  <span>Heuristik Partners</span> </h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="bg-white p-6 rounded-lg shadow-md">
                ...
                <p class="text-gray-600">Nous nous engageons à la confidentialité totale et à la protection de vos données notamment personnelles.</p>
            </div>
        </div>
    </div>
</section>