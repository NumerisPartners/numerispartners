...
@section('content')
    ...
    <section class="py-16 bg-indigo-600 text-white">
        <div class="container mx-auto px-4 text-center">
            ...
            <p class="text-xl mb-8 max-w-3xl mx-auto">Contactez-nous dès aujourd'hui pour discuter de vos besoins et obtenir un devis personnalisé.</p>
            <a href="{{ route('contact.index') }}" class="bg-white text-indigo-600 hover:bg-gray-100 px-8 py-4 rounded-lg font-semibold text-lg transition inline-block">Demander un devis</a>
        </div>
    </section>
@endsection
