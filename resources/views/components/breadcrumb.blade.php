@props(['title'])
<div class="breadcrumb-area pt-32  pb-11  md:pt-40  md:pb-26 bg-gradient-to-r from-blue-50 to-slate-50 dark:bg-gradient-to-r dark:from-[#3e2485] dark:to-[#0e032d]">
    <div class="container">
