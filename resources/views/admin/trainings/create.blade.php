                    ...
                    <form action="{{ route('admin.trainings.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="title" class="block mt-1 w-full dark:bg-gray-900 dark:text-gray-300" type="text" name="title" :value="old('title')" required autofocus />
                            ...
                            <div>
                                ...
                                <x-text-input id="individual_price" class="block mt-1 w-full dark:bg-gray-900 dark:text-gray-300" type="number" name="individual_price" :value="old('individual_price')" step="0.01" min="0" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="company_price" class="block mt-1 w-full dark:bg-gray-900 dark:text-gray-300" type="number" name="company_price" :value="old('company_price')" step="0.01" min="0" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="duration" class="block mt-1 w-full dark:bg-gray-900 dark:text-gray-300" type="text" name="duration" :value="old('duration')" placeholder="Ex: 3 jours, 21 heures" required />
                            ...
                            <div class="flex items-center mt-4">
                                <input id="is_active" type="checkbox" name="is_active" value="1" {{ old('is_active') ? 'checked' : '' }} class="rounded dark:bg-gray-900 border-gray-300 dark:border-gray-700 text-indigo-600 shadow-sm focus:ring-indigo-500 dark:focus:ring-indigo-600 dark:focus:ring-offset-gray-800">
                                <label for="is_active" class="ml-2 text-sm text-gray-600 dark:text-white">{{ __('Formation active') }}</label>
                            </div>
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="content" name="content" rows="10" class="block mt-1 w-full px-3 py-2 border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">{{ old('content') }}</textarea>
                            <x-input-error :messages="$errors->get('content')" class="mt-2" />
                        </div>

                        <!-- Informations pratiques -->
                        <div class="mb-6">
                            <h3 class="font-semibold text-lg text-gray-800 dark:text-gray-200 mb-4 dark:bg-white">{{ __('Informations pratiques') }}</h3>
                            
                            <!-- Public cible -->
                            <div class="mb-4">
                                <x-input-label class="dark:text-white" for="target_audience" :value="__('Public cible')" />
                                <textarea id="target_audience" name="target_audience" rows="3" class="block mt-1 w-full px-3 py-2 border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">{{ old('target_audience') }}</textarea>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea id="teaching_methods" name="teaching_methods" rows="3" class="w-full px-4 py-3 bg-white dark:bg-[#050231] border border-gray-300 dark:border-gray-700 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 ">{{ old('teaching_methods') }}</textarea>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea id="evaluation_methods" name="evaluation_methods" rows="3" class="w-full px-4 py-3 bg-white dark:bg-[#050231] border border-gray-300 dark:border-gray-700 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 ">{{ old('evaluation_methods') }}</textarea>
