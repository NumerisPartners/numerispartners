                        ...
                        <form action="{{ route('admin.trainings.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="individual_price" class="block mt-1 w-full" type="number" name="individual_price" :value="old('individual_price')" step="0.01" min="0" required />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="company_price" class="block mt-1 w-full" type="number" name="company_price" :value="old('company_price')" step="0.01" min="0" required />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="duration" class="block mt-1 w-full" type="text" name="duration" :value="old('duration')" placeholder="Ex: 3 jours, 21 heures" required />
